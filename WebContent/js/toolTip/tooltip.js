...
var tooltip = function(w) {
	...
	var Qb = function(a) {
		return a.pointerType == a.MSPOINTER_TYPE_MOUSE
				|| a.pointerType == "mouse"
	}, oc = "marginTop", lc = "marginLeft", x = "offsetWidth", m = "offsetHeight", ub = "documentElement", nc = "borderColor", ib = "nextSibling", e = "style", z = "width", o = "left", p = "top", J = "height", jc = [
			"$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22" ], y, ob, B = function(
			c, a, b) {
		...
		if (document.styleSheets && document.styleSheets.length) {
			...
			c.insertRule(d, 0);
			var e = "#tooltipAjaxSpin {margin:30px;font-size:0;width:20px;height:20px;border-width:3px;border-color:rgba(255,255,255,.8);border-style:solid;border-top-color:black;border-right-color:rgba(0,0,0,.8);border-radius:50%;"
					+ a + "animation:mcttSpinner .6s linear infinite;}";
			c.insertRule(e, 0)
		}
	}, s = null, Zb = {
		a : function(d, b, a) {
